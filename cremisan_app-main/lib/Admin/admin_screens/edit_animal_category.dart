...
class EditAnimalCategory extends StatefulWidget {
  final CategoryModel? category;

  const EditAnimalCategory({Key? key, this.category}) : super(key: key);

  @override
  _EditAnimalCategoryState createState() => _EditAnimalCategoryState();
}

class _EditAnimalCategoryState extends State<EditAnimalCategory> {
  ...
  void _submitForm() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (_formKey.currentState!.validate()) {
        var response = await FirebaseAnimalCategories.updateCategory(
          docId: _docId.text,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(AppLocalizations.of(context)?.editanimalcategory ??
            "value becomes null"),
        leading: IconButton(
          icon: const Icon(
