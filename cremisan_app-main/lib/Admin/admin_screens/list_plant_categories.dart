...
import 'package:cremisan_app1/Admin/admin_screens/add_plant_category.dart';
import 'package:cremisan_app1/Admin/admin_screens/edit_plant_category.dart';
...
class ListPlantCategories extends StatefulWidget {
  const ListPlantCategories({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _ListPlantCategoriesState();
  }
}

class _ListPlantCategoriesState extends State<ListPlantCategories> {
            ...
            onPressed: () {
              Navigator.pushAndRemoveUntil<dynamic>(
                ...
                MaterialPageRoute<dynamic>(
                  builder: (BuildContext context) => AddPlantCategory(),
                ),
                (route) => false,
              );
            },
