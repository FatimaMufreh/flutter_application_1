...
class ReservedWines extends StatefulWidget {
  const ReservedWines({Key? key}) : super(key: key);

  @override
  State<ReservedWines> createState() => _ReservedWinesState();
}

class _ReservedWinesState extends State<ReservedWines> {
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> sampleEvents = [
      {
        'name': AppLocalizations.of(context)?.reserve ?? "value becomes null",
        'image': "assets/reserve.png",
      },
      {
        'name': AppLocalizations.of(context)?.cabernet ?? "value becomes null",
        'image': "assets/caberent.png",
      },
    ];
