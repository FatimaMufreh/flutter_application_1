...
class SuperAlcohol extends StatefulWidget {
  const SuperAlcohol({Key? key}) : super(key: key);

  @override
  State<SuperAlcohol> createState() => _SuperAlcoholState();
}

class _SuperAlcoholState extends State<SuperAlcohol> {
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> sampleEvents = [
      {
        'name': AppLocalizations.of(context)?.brandy ?? "value becomes null",
        'image': "assets/brandi3.png",
      },
      {
        'name': AppLocalizations.of(context)?.arak ?? "value becomes null",
        'image': "assets/arak.jpg",
      },
    ];
